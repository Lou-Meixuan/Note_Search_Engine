...
const translations = {
    ...
    en: {
        ...
        accountExistsWithDifferentCredential: "This email is already registered with another sign-in method. Please use the original method.",
        ...
        signedInHint: "Your documents are synced with your account.",
        privacyHint: "We only use your email for authentication. Your data stays private.",
        anonymousUser: "Guest User",
        linkAccountHint: "Link your account to save documents permanently",
        linkAccount: "Link Account",
        anonymousWarning: "Your documents will be deleted if you don't link an account.",
        accountAlreadyExists: "This account is already linked to another user",
        plan: "Plan",
    ...
    zh: {
        ...
        loginError: "登录失败，请重试。",
        accountExistsWithDifferentCredential: "此邮箱已通过其他方式注册，请使用原来的登录方式。",
        featureSearch: "智能搜索",
        featureUpload: "上传笔记",
        featureSync: "云端同步",
        ...
        signedInHint: "你的文档已与账户同步。",
        privacyHint: "我们仅使用你的邮箱进行身份验证，你的数据将保持私密。",
        anonymousUser: "访客用户",
        linkAccountHint: "绑定账户以永久保存文档",
        linkAccount: "绑定账户",
        anonymousWarning: "不绑定账户，你的文档将会被删除。",
        accountAlreadyExists: "该账户已关联其他用户",
        plan: "方案",
        memberSince: "注册时间",
        storage: "存储",
        sync: "同步",
    ...
    ja: {
        ...
        accountExistsWithDifferentCredential: "このメールアドレスは別の方法で登録されています。元の方法でログインしてください。",
        ...
        signedInHint: "ドキュメントはアカウントと同期されています。",
        privacyHint: "認証にのみメールを使用します。データはプライベートに保たれます。",
        anonymousUser: "ゲストユーザー",
        linkAccountHint: "アカウントを連携してドキュメントを永続的に保存",
        linkAccount: "アカウントを連携",
        anonymousWarning: "アカウントを連携しないと、ドキュメントは削除されます。",
        accountAlreadyExists: "このアカウントは既に他のユーザーに連携されています",
        plan: "プラン",
        memberSince: "登録日",
        storage: "ストレージ",
        sync: "同期",
    ...
    ko: {
        ...
        accountExistsWithDifferentCredential: "이 이메일은 다른 로그인 방법으로 등록되어 있습니다. 원래 방법을 사용하세요.",
        ...
        signedInHint: "문서가 계정과 동기화됩니다.",
        privacyHint: "인증에만 이메일을 사용합니다. 데이터는 비공개로 유지됩니다.",
        anonymousUser: "게스트 사용자",
        linkAccountHint: "계정을 연결하여 문서를 영구적으로 저장",
        linkAccount: "계정 연결",
        anonymousWarning: "계정을 연결하지 않으면 문서가 삭제됩니다.",
        accountAlreadyExists: "이 계정은 이미 다른 사용자에게 연결되어 있습니다",
        plan: "플랜",
        memberSince: "가입일",
        storage: "저장소",
        sync: "동기화",
    ...
    es: {
        ...
        accountExistsWithDifferentCredential: "Este correo ya está registrado con otro método. Por favor usa el método original.",
        ...
        signedInHint: "Tus documentos están sincronizados con tu cuenta.",
        privacyHint: "Solo usamos tu correo para autenticación. Tus datos se mantienen privados.",
        anonymousUser: "Usuario Invitado",
        linkAccountHint: "Vincula tu cuenta para guardar documentos permanentemente",
        linkAccount: "Vincular Cuenta",
        anonymousWarning: "Tus documentos serán eliminados si no vinculas una cuenta.",
        accountAlreadyExists: "Esta cuenta ya está vinculada a otro usuario",
        plan: "Plan",
    ...
    fr: {
        ...
        accountExistsWithDifferentCredential: "Cet email est déjà enregistré avec une autre méthode. Veuillez utiliser la méthode originale.",
        ...
        signedInHint: "Vos documents sont synchronisés avec votre compte.",
        ...
        linkAccountHint: "Liez votre compte pour sauvegarder vos documents de façon permanente",
        linkAccount: "Lier le Compte",
        anonymousWarning: "Vos documents seront supprimés si vous ne liez pas de compte.",
        accountAlreadyExists: "Ce compte est déjà lié à un autre utilisateur",
        plan: "Forfait",
    ...
    de: {
        ...
        accountExistsWithDifferentCredential: "Diese E-Mail ist bereits mit einer anderen Methode registriert. Bitte verwenden Sie die ursprüngliche Methode.",
        ...
        signedInHint: "Ihre Dokumente werden mit Ihrem Konto synchronisiert.",
        privacyHint: "Wir verwenden Ihre E-Mail nur zur Authentifizierung. Ihre Daten bleiben privat.",
        anonymousUser: "Gastbenutzer",
        linkAccountHint: "Verknüpfen Sie Ihr Konto, um Dokumente dauerhaft zu speichern",
        linkAccount: "Konto Verknüpfen",
        anonymousWarning: "Ihre Dokumente werden gelöscht, wenn Sie kein Konto verknüpfen.",
        accountAlreadyExists: "Dieses Konto ist bereits mit einem anderen Benutzer verknüpft",
        plan: "Plan",
